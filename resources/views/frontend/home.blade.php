...
@section('content')
    ...
    <div class="container">
        ...
        <section class="py-5">
            <header>
                <h2 class="h5 text-uppercase mb-4">Top trending brands</h2>
            </header>
            <div class="row">
                <!-- PRODUCT-->
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="product text-center">
                            <div class="position-relative mb-3">
                                <div class="badge text-white badge-"></div><a class="d-block" href="detail.html"><img class="img-fluid w-100" src="{{ asset('dashboard/brands/' . $brand->image) }}" alt="..."></a>
            ...
            <div class="row">
                @foreach($products as $product)
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="product text-center">
                            <div class="position-relative mb-3">
                                <div class="badge text-white badge-"></div><a class="d-block" href="detail.html"><img class="img-fluid w-100" src="{{ asset('dashboard/products/' . $product->image) }}" alt="..."></a>
                                <div class="product-overlay">
                                    <ul class="mb-0 list-inline">
